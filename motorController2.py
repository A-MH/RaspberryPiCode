...
en_values = {"front": 20, "back": 1, "left": 25, "right": 17}

pwm_pins = {"front": None, "back": None, "left": None, "right": None}

in_values = {"front": [16, 12], "back": [8, 7], "left": [24, 23], "right": [18, 15]}
...
#         print("entered loop")
        ...
        if not junction_registered and (deviation[sensor_left] > left_dev or deviation[sensor_right] > right_dev):
        ...
        if junction_registered and deviation[sensor_left] < left_dev and deviation[sensor_right] < right_dev:
            junction_registered = False
